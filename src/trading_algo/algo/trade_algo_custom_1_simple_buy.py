...
from src.trading_algo.metrics_calculation.custom_1_metrics_ta import Custom_1_Metrics_TA
from config import base_directory_project

test_data_output_path = base_directory_project + "\\" + 'output_data'

class TradeAlgoCustom1simpleBuy(trade_algo_structure):
    def __init__(self,base_stock_name, datetime_of_algo_execution):
        ...
        self._pattern_for_option_selection_for_strategy = [
            {'type': 'CE', 'sel_criteria': 'strike_price', 'itm_atm_otm': 'otm', 'delta_strike_price': -300,
             'option_name': '', 'execution_strategy': {'simple_buying': {'long_action': 'BUY'}}},
            {'type': 'PE', 'sel_criteria': 'strike_price', 'itm_atm_otm': 'otm', 'delta_strike_price': -300,
             'option_name': '', 'execution_strategy': {'simple_buying': {'short_action': 'BUY'}}}]
        self.selected_option_strategy = 'simple_buying'
        self.order_book_name = 'sma_trade_orderbook__custom_1_simple_buying'

    def initialise_metrics_obj(self):
        self.metrics_obj = Custom_1_Metrics_TA(200)
        self.metrics_col_name = 'custom_1_value'
    ...
    def check_if_entry_exists(self):
        ...
        metric_value = list(self.base_stock_data[self.base_stock_data['datetime'] == max_datetime][self.metrics_col_name])[0]
...
if __name__=="__main__":
    ...
    #back_test_start_date = datetime.datetime(2022, 2, 1, 9, 30, 0)
    #back_test_start_date = datetime.datetime(2022, 3, 1, 9, 30, 0)
    back_test_start_date = datetime.datetime(2022, 4, 8, 9, 30, 0)
    #back_test_start_date = datetime.datetime(2022, 6, 1, 9, 30, 0)
    ...
    #back_test_start_date = datetime.datetime(2022, 7, 1, 9, 30, 0)
    ...
    back_test_end_date = datetime.datetime(2022, 6, 1, 9, 30, 0)
    #back_test_end_date = datetime.datetime(2022, 6, 30, 9, 30, 0)
    #back_test_end_date = datetime.datetime(2022, 7, 31, 9, 30, 0)
    ...
    while (cur_date <= back_test_end_date):
        ...
        data_interface_obj = TradeAlgoCustom1simpleBuy('BANKNIFTY', cur_date).running_trade_algo()
